...
#     sensor_ids, sensor_id_to_ind, adj_mx = load_pickle(ADJPATH)
    ...
    model = dcrnn00(device, adj_mx, input_dim=1, output_dim=3, seq_len=12, horizon=12, use_curriculum_learning=False, num_nodes=307, max_diffusion_step=2, cl_decay_steps=2000, filter_type='dual_random_walk', num_rnn_layers=2, rnn_units=64).to(device)
