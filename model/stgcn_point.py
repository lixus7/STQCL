...
class stgcn_point(nn.Module):
    def __init__(self, ks, kt, bs, T, n, Lk, p, quantiles, TIMESTEP_OUT):
        super(stgcn_point, self).__init__()
    ...
    def forward(self, x):
        ...
        output_2 = output_1.reshape(-1, 12, 1, output_1.shape[3]).permute(0, 1, 3, 2)
...
def main():
    ...
    model = stgcn_point(ks, kt, bs, T, n, Lk, p, QUANTILES, TIMESTEP_OUT).to(device)
